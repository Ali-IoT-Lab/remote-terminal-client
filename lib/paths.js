...
module.exports = {
    TERMINAL_ID_PATH         : p.resolve(MOJA_HOME, 'mojaConfig/terminalId.json'),
    PUBLIC_KEY_PATH          : p.resolve(MOJA_HOME, 'mojaConfig/publicKey.json'),
    EMAIL_PATH               : p.resolve(MOJA_HOME, 'mojaConfig/email.json'),
    USER_ID_PATH             : p.resolve(MOJA_HOME, 'mojaConfig/userId.json'),
